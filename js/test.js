...
function showComments() {
    ...
    <div>
    <div>
     <p>${currentComments[0].user} + ${currentComments[0].dateTime} + ${currentComments.score}</p>
     <p>${currentComments[1].user} + ${currentComments[1].dateTime} + ${currentComments.score}</p>
    </div>
    <div>
